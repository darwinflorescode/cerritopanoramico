...
<li><a style='cursor:pointer;' data-toggle='modal' data-target='#modal_update' data-placement='bottom' title='Editar Registro' onclick='editarmesero(".$row['idmesero'].");'><i class='fa fa-edit'></i> Editar</a></li>";
...
<li><a style="cursor:pointer;" data-toggle="tooltip" data-placement="left" title="Eliminar Registro!" onclick='eliminarmesero(<?php echo $row['idmesero'];?>)'><i class='fa fa-trash'></i> Borrar</a></li>
</ul>
</div> 
</td>
