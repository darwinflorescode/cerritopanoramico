...
//funcion que sirve para guardar los datos de la materia
	...
	try{
 		...
 		$stmt = $conn->prepare("INSERT INTO entradas(descripcion, ideventosespeciales) VALUES(:a, :b);");
...
//funcion para poder modificar los registros
	...
	function modificar($descripcion, $eventosespeciales, $id)
		...
		$sql = "UPDATE entradas SET descripcion='$descripcion', ideventosespeciales='$eventosespeciales' where identradas ='$id'";
	...
	function eliminar($id){
		...
		$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$sql = "DELETE FROM  entradas WHERE identradas = $id";
