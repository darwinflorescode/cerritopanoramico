...
<!-- Caja de estilos -->
<h3 class="box-title">Listado de tipos de usuario </h3>
</div> 
<div class="box-body">
...
<!-- cargando datos de busqueda-->
  ...
  //Requerimos el archivo donde se encuentra la consulta de busqueda
      require_once('view/viewusertype.php');
...
//funcion para crear la busqueda en tiempo real 
    function load(page){
      ...
      $.ajax({
        ...
        url:'view/viewusertype.php?action=ajax&page='+page+'&q='+q+'&per_page='+per_page,
