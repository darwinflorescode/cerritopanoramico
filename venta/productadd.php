...
<div class='alert alert-info alert-dismissable'>
  ...
  on detalleorden.idproducto = producto.idproducto WHERE idorden = $idventa";
  $res = $conn->query($que);
  $filas = $res->fetchAll();
  $todo = count($filas);
...
<table class="table table-condensed table-hover table-striped">
  ...
  ?>
    <tr>
      ...
      <td><?php echo $mostrar['cantidad'] ; ?></td>
        ...
        <td><span class='glyphicon glyphicon-usd'></span><?php echo $mostrar['precioactual'] ; ?></td>
  ...
  $query = $conn->prepare("SELECT sum(subtotal) AS total FROM detalleorden where idorden = '$idventa'");
      $query->execute();
...
<tr>
      ...
      <tr>
          ...
          <td colspan="3" style=" text-align:right;"><strong style="font-size: 12px;">MESERO(10%): &nbsp;</strong></td>
            <td><?php echo "<span class='glyphicon glyphicon-usd'></span> ".number_format($mese,2) ;?></td>
       ...
       <tr>
          ...
          <td colspan="3" style=" text-align:right;"><strong style="font-size: 12px;">TOTAL A PAGAR: &nbsp;</strong></td>
            <td><?php echo "<span class='glyphicon glyphicon-usd'></span> ".number_format($totalparcial+$mese,2) ;?></td>
