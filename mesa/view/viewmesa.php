...
while ($row = $q->fetch()) {
        ...
        if ($imagend!="") {
        	...
        	echo '<td><img src="img/1.jpg" id="imga"></td>';
        }
...
<li><a style='cursor:pointer;' data-toggle='modal' data-target='#modal_update' data-placement='bottom' title='Editar Registro' onclick='editarmesa(".$row['idmesa'].");'><i class='fa fa-edit'></i> Editar</a></li>";



?>
<!-- esta linea sirve para eliminar un registro-->
<li><a style="cursor:pointer;" data-toggle="tooltip" data-placement="left" title="Eliminar Registro!" onclick='eliminarmesa(<?php echo $row['idmesa'];?>)'><i class='fa fa-trash'></i> Borrar</a></li>
</ul>
</div> 
</td>
