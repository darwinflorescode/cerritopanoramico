...
<li class="active" onclick="per_page(5);" id="5"><a href="reporteventa.php#">5</a></li>
<li onclick="per_page(10);" id="10"><a href="reporteventa.php#">10</a></li>
<li onclick="per_page(20);" id="20"><a href="reporteventa.php#">20</a></li>
<li onclick="per_page(50);" id="50"><a href="reporteventa.php#">50</a></li>
<li onclick="per_page(1000);" id="1000"><a href="reporteventa.php#">Todos</a></li>
</ul>
...
<li><a href="javascript:window.open(imprimirventatodos())"><i class="fa fa-print"></i> Todos</a></li>
<li><a href="javascript:window.open(imprimirventafecha())"><i class="fa fa-print"></i> Fechas</a></li>
...
<div class="vertabla"></div>
 ...
 <?php 
  //incluimos el archivo de busqueda donde se hacen las consultas
      require_once('view/viewventa.php');
...
//Funcion load para cargar los datos de la busqueda
    function load(page){
      ...
      $.ajax({
        ...
        url:'view/viewventa.php?action=ajax&page='+page+'&q='+q+'&per_page='+per_page,
