...
<li class="active" onclick="per_page(5);" id="5"><a href="reporteventosespeciales.php#">5</a></li>
<li onclick="per_page(10);" id="10"><a href="reporteventosespeciales.php#">10</a></li>
<li onclick="per_page(20);" id="20"><a href="reporteventosespeciales.php#">20</a></li>
<li onclick="per_page(50);" id="50"><a href="reporteventosespeciales.php#">50</a></li>
<li onclick="per_page(1000);" id="1000"><a href="reporteventosespeciales.php#">Todos</a></li>
</ul>
...
<li><a href="javascript:window.open(imprimireventosespecialestodos())"><i class="fa fa-print"></i> Todos</a></li>
<li><a href="javascript:window.open(imprimireventosespecialesfecha())"><i class="fa fa-print"></i> Fechas</a></li>
...
<h3 class="box-title">Listado de Eventos Especiales</h3>
</div> 
<div class="box-body">
...
<div class="vertabla"></div>
 ...
 <!-- sirve para llamar el archivo vieweventosespeciales que es el que contiene las funciones de busqueda -->
 <?php 

 
      require_once('view/vieweventosespeciales.php');
 ...
 //funcion para cargarr los datos
  $(document).ready(function(){
    ...
    function load(page){
      ...
      $("#loader").fadeIn('slow');
      $.ajax({
        url:'view/vieweventosespeciales.php?action=ajax&page='+page+'&q='+q+'&per_page='+per_page,
