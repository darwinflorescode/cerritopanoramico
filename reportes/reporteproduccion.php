...
<input type="date" value="<?php date_default_timezone_set('America/El_Salvador');
echo date('Y-m-d');?>" id="desde" class="form-control pull-right"   required>
</div>
</div>
<div class="col-xs-1">
<div class="input-group">
...
<li class="active" onclick="per_page(5);" id="5"><a href="reporteproduccion.php#">5</a></li>
<li onclick="per_page(10);" id="10"><a href="reporteproduccion.php#">10</a></li>
<li onclick="per_page(20);" id="20"><a href="reporteproduccion.php#">20</a></li>
<li onclick="per_page(50);" id="50"><a href="reporteproduccion.php#">50</a></li>
<li onclick="per_page(1000);" id="1000"><a href="reporteproduccion.php#">Todos</a></li>
</ul>
...
<li><a href="javascript:window.open(imprimirproducciontodos())"><i class="fa fa-print"></i> Todos</a></li>
<li><a href="javascript:window.open(imprimirproduccionfecha())"><i class="fa fa-print"></i> Fechas</a></li>
