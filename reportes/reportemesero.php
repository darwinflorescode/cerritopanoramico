...
<li class="active" onclick="per_page(5);" id="5"><a href="reportemesero.php#">5</a></li>
<li onclick="per_page(10);" id="10"><a href="reportemesero.php#">10</a></li>
<li onclick="per_page(20);" id="20"><a href="reportemesero.php#">20</a></li>
<li onclick="per_page(50);" id="50"><a href="reportemesero.php#">50</a></li>
<li onclick="per_page(1000);" id="1000"><a href="reportemesero.php#">Todos</a></li>
</ul>
...
<li><a href="javascript:window.open(imprimirmeserotodos())"><i class="fa fa-print"></i> Todos</a></li>
<li><a href="javascript:window.open(imprimirmeserofecha())"><i class="fa fa-print"></i> Fechas</a></li>
