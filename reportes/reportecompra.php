...
<li class="active" onclick="per_page(5);" id="5"><a href="reportecompra.php#">5</a></li>
<li onclick="per_page(10);" id="10"><a href="reportecompra.php#">10</a></li>
<li onclick="per_page(20);" id="20"><a href="reportecompra.php#">20</a></li>
<li onclick="per_page(50);" id="50"><a href="reportecompra.php#">50</a></li>
<li onclick="per_page(1000);" id="1000"><a href="reportecompra
.php#">Todos</a></li>
</ul>
...
<li><a href="javascript:window.open(imprimircompratodos())"><i class="fa fa-print"></i> Todos</a></li>
<li><a href="javascript:window.open(imprimircomprafecha())"><i class="fa fa-print"></i> Fechas</a></li>
...
<div class="vertabla"></div>
 ...
 //incluimos el archivo de busqueda donde se hacen las consultas
      require_once('view/viewcompra.php');
 ...
 //funcion para cargarr los datos
  $(document).ready(function(){
    ...
    function load(page){
      ...
      $("#loader").fadeIn('slow');
      $.ajax({
        url:'view/viewcompra.php?action=ajax&page='+page+'&q='+q+'&per_page='+per_page,
