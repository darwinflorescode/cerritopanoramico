...
$qg = $connection->prepare("SELECT sum(cantidad) as cant,sum(preciounitario) as precios,sum(total) as tot FROM producto");
       $qg->execute();
...
<td><span class="badge label-success"><li class='glyphicon glyphicon-usd '></li> <?php echo number_format($totalp,2); ?></span></td>
 ...
 <td><span class="badge label-primary"><?php echo $entradas; ?></span></td>

 <td><span class="badge label-info"><?php echo $canti; ?></span></td>
 <td><span class="badge label-warning"><?php echo $salidas; ?></span></td>
