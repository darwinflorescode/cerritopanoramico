...
//Query con l tabla mesa
        $sql = "SELECT * FROM mesa where  fecha BETWEEN '$desde' AND '$hasta' order by idmesa desc";
        ...
        $sql = "SELECT * FROM mesa where idmesa > 1 order by idmesa desc";
...
<table id="ds" width="100%" align="center" style="font-size: 10pt; border-collapse: collapse; " cellpadding="8">

<thead>
<tr style="background-color:#EEEEEE;">
<td colspan="4"><b>Reporte de Mesas<b>&nbsp;&nbsp;&nbsp;'.$total.'&nbsp;&nbsp;&nbsp;registros</td>
...
foreach($model as $row)
...

    {
      ...
      if ($des!="") {
        ...
        $html .='</td><td>'.date("d-m-Y", strtotime($row['fecha'])).'</td><td>'.$row['estado'].'</td>';
...
$mpdf->SetTitle("Reporte mesas ".$fecha);
...
$mpdf->Output('Reporte Mesas  '.$fecha.'.pdf','I');
