...
<link rel="stylesheet" href="../lib/stiloadmin.css">
  ...
  <!-- CSS  definir acncho alto ect del contenedor del formulario -->
   ...
   <!--  Titulo que aparece en la pestaña del navegador-->
	<title>Restaurante | Cerrito Panor&acute;mico</title>
</head>
<body oncontextmenu="return false">

<?php 
//menu negro que aparece arriba del formulario
        ...
        <div class="card card-container">
            ...
            <?php
            	...
            	if (!empty($_GET['noexiste'])) {
            		...
            		echo"<meta http-equiv='refresh' content='3; url=http://localhost/cerritopanoramico/recuperar/desbloquear.php'/ >";
            	}
...
$cod = addslashes($_POST['code']);
 ...
 <center><strong>Copyright &copy; 2016 <a href="http://fademype.org.sv/fademype/?p=1647" target="_blank"><font size="2" color="black">Sistema de Restaurante El Cerrito Panor&aacute;mico</font></a></strong></center>
<br>
