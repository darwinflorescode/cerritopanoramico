          ...
          alertify.confirm("<p><img src='./img/warning.png'>&nbsp;&nbsp;&nbsp; <b>Ha alcanzado sus 3 Intentos maximos<br><b>Usuario bloqueado!</b><br><br><b>¿Desea desbloquearlo?</b><br><br></p>",
            function(e) {
              ...
              //Sino retorna false y se queda en el login mostrando el respectvo mensjae
                ...
                alertify.log("¿Si no puede desbloquear?. Comuniquese con el Admin...");
                return false;
              }
            });
        }
    ...
    <div class="row vertical-center-row">
      ...
      <form action="./recuperar/enviar.php" accept-charset="utf-8" name="loginform" autocomplete="off" role="form" method="POST">
        <div id="loginarea">
          ...
          <center>
            <h6>
              <font color="black">INICIO DE SESI&Oacute;N</font>
            </h6>
          </center>
          <?php
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" value="darwin" class="form-control" name="usu" placeholder="Ingrese su usuario" required />
              </div>
              <div class="form-group">
                ...
                <input type="password" value="12345" class="form-control" name="pass" placeholder="Ingrese su contrase&ntilde;a" required />
              </div>
          ...
          <!-- Derechos reservados del creador -->
          <center><strong>Copyright &copy; <?php echo date('Y'); ?> <a href="http://fademype.org.sv/fademype/?p=1647" target="_blank">
                <font color="black">Sistema de El Restaurante Cerrito Panor&aacute;mico</font>
              </a></strong></center>
