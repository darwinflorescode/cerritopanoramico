...
if (isset($_POST['accion'])) {
  ...
  $descripcion = $_POST['descripcion'];
 	...
 	$query = $conn->prepare("SELECT  * FROM tipoadicional where descripcion='$descripcion' and ideventosespeciales='$ideven'");
 	$query->execute();
	$row = $query->rowcount();
       if ($row)
       {
       echo "<script>location.href='step4.php?idevento=".$ideven."&message=error'; </script> ";
       }else{

       	$insertar = $conn->prepare("INSERT INTO tipoadicional(descripcion,ideventosespeciales) VALUES('".$descripcion."','$ideven')");
       	$insertar->execute();
...
/*
    ...
    echo "<script>location.href='step4.php?idevento=".$ideven."&message=add'; </script> ";
...
<div class="col-md-20">
<form class="form-horizontal" action="step4.php" method="POST" accept-charset="utf-8"   autocomplete="off" role="form" >
...
<li class="active"><a href="step4.php?idevento=<?php echo $_GET['idevento']; ?>" data-toggle="" aria-expanded="false">Adicional Incluye. Paso 4 </a></li>
...
<textarea class="form-control" required name="descripcion" id="descripcion" Placeholder="Ingrese una descripci&oacute;n adicional"></textarea>
...
<div class="col-sm-4">
 ...
 <a href="step5.php?idevento=<?php echo $_GET['idevento']; ?>" class="btn btn-info"> Siguiente <span class="fa fa-chevron-right"></span></a>
