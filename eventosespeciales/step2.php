...
if (isset($_POST['accion'])) {
  ...
  $descripcion = $_POST['descripcion'];
 	...
 	$query = $conn->prepare("SELECT  * FROM entradas where descripcion='$descripcion' and ideventosespeciales='$ideven'");
 	$query->execute();
	$row = $query->rowcount();
       if ($row)
       {
       echo "<script>location.href='step2.php?idevento=".$ideven."&message=error'; </script> ";
       }else{

       	$insertar = $conn->prepare("INSERT INTO entradas(descripcion,ideventosespeciales) VALUES('".$descripcion."','$ideven')");
       	$insertar->execute();
...
/*
    ...
    echo "<script>location.href='step2.php?idevento=".$ideven."&message=add'; </script> ";
...
<div class="col-md-20">
<form class="form-horizontal" action="step2.php" method="POST" accept-charset="utf-8"   autocomplete="off" role="form" >
<div class="nav-tabs-custom">
<ul class="nav nav-tabs">
<li class=""><a href="crearevento.php" data-toggle="" aria-expanded="false">Nuevo Evento</a></li>
<li class="active"><a  href="step2.php?idevento=<?php echo $_GET['idevento']; ?>" data-toggle="" aria-expanded="false">Entradas. Paso 2 </a></li>
...
<textarea class="form-control" required name="descripcion" id="descripcion" Placeholder="Ingrese una descripci&oacute;n de Entradas"></textarea>
...
<div class="col-sm-4">
 ...
 <a href="step3.php?idevento=<?php echo $_GET['idevento']; ?>" class="btn btn-info"> Siguiente <span class="fa fa-chevron-right"></span></a>
...
<?php 
    ...
    echo "<center><div class='alert alert-danger'><h1>Ha ocurrido Un error</h1></div></center>";
  }
