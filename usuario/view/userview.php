...
<li><a style='cursor:pointer;' data-toggle='modal' data-target='#modal_update' data-placement='bottom' title='Editar Registro' onclick='editarusuario(".$row['idusuario'].");''><i class='fa fa-edit'></i> Editar</a></li>";
...
?>
<li><a style="cursor:pointer;" data-toggle='modal' data-target='#modal_activar' data-placement="left" title="Desactivar Registro!" onclick='activar(<?php echo $row['idusuario'];?>);'><i class='fa fa-close'></i> Desactivar</a></li>

<?php

}elseif ($estado =="Inactivo") {
  ?>
<li><a style='cursor:pointer;' data-toggle='modal' data-target='#modal_activar' onclick='activar(<?php echo $row['idusuario'];?>);'><i class='fa fa-check-circle'></i> Activar</a></li>
...
<li><a style="cursor:pointer;" data-toggle="tooltip" data-placement="left" title="Eliminar Registro!" onclick='eliminarusuario(<?php echo $row['idusuario'];?>)'><i class='fa fa-trash'></i> Borrar</a></li>
<li><a style="cursor:pointer;" data-toggle='modal' data-target='#modal_cambiarpass' data-placement="left" title="Cambiar Contraseña!" onclick='cambiarpass(<?php echo $row['idusuario'];?>);'><i class='fa fa-lock'></i> Cambiar contrase&ntilde;a</a></li>
</ul>
</div> 
</td>
